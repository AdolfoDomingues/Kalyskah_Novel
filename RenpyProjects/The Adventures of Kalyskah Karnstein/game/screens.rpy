...
screen navigation():
    ...
    vbox xpos 188 ypos 690:
        ...
        if _in_replay:
            ...
            textbutton ("End Replay") action EndReplay(confirm=True) text_size 40 text_font "gui/fonts/BebasNeue/TTF/BebasNeue-Regular.ttf"

        elif not main_menu:

            textbutton ("Main Menu") action MainMenu() text_size 40 text_font "gui/fonts/BebasNeue/TTF/BebasNeue-Regular.ttf"
