...
label start:
    ...
    scene HighresScreenshot00053
    Kalyskah "Just like this one."
    scene HighresScreenshot00054
    Kalyskah "Just one of the many things that changed, I suppose."
    scene HighresScreenshot00055
    window hide # hides the window.
    $ renpy.pause()
    scene HighresScreenshot00056
    Merishya "Oh! That sounds lovely. I’m used to hot places!"
    Kalyskah "Hehe. I see what you did there.."

    scene HighresScreenshot00057
    window hide # hides the window.
    $ renpy.pause()
    scene HighresScreenshot00058
    window hide # hides the window.
    $ renpy.pause()
    scene HighresScreenshot00059
    window hide # hides the window.
    $ renpy.pause()
    scene HighresScreenshot00060
    window hide # hides the window.
    $ renpy.pause()
    scene HighresScreenshot00061
    window hide # hides the window.
    $ renpy.pause()
    scene HighresScreenshot00062
    window hide # hides the window.
    $ renpy.pause()
    scene HighresScreenshot00063
    window hide # hides the window.
    $ renpy.pause()
    scene HighresScreenshot00064
    Merishya "Sweetie.."
    scene HighresScreenshot00065
    Merishya "Are you all right?"
    scene HighresScreenshot00066
    Kalyskah "Yes… I am fine."
    scene HighresScreenshot00067
    window hide # hides the window.
    $ renpy.pause()
    scene HighresScreenshot00068
    Merishya "Want to be left alone for a moment?"
    scene HighresScreenshot00069
    window hide # hides the window.
    $ renpy.pause()
    scene HighresScreenshot00070


    menu:
        "Stay with me.": #1
            scene HighresScreenshot00071
            Kalyskah "I do not want to be alone... I have been lonely for far too long."
            scene HighresScreenshot00072
            Kalyskah "Please, do not go." 
            Merishya "Want to talk about it?"
            scene HighresScreenshot00073
            Kalyskah "No... Just– just kiss me."

            #*Merishya looks surprised. They start making out.*

            scene HighresScreenshot00074
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00075
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00076
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00077
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00078
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00079
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00080
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00081
            window hide # hides the window.
            $ renpy.pause()

            scene HighresScreenshot00082
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00083
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00084
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00085
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00086
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00087
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00088
            window hide # hides the window.
            $ renpy.pause()
            scene HighresScreenshot00089
            Kalyskah "Oh, my…"
            scene HighresScreenshot00090
            Kalyskah "Yes… go lower…"
            "Merishya puts her hands on the clothes on Kalyskah’s chest"
            scene HighresScreenshot00091
            Merishya "Hehe.."
            scene HighresScreenshot00092
            Kalyskah "Why are you looking at me like that?"
            scene HighresScreenshot00093
            ...
            Merishya "Can I?"
            scene HighresScreenshot00102
            Merishya "I had an idea in that case:"
            scene HighresScreenshot00103
            ...
            menu:
                "Choose pussy":  #1.a 
                    ...
                    scene HighresScreenshot00104
                    Merishya "Your wish is my command, lady!"
                    scene HighresScreenshot00105
                    Kalyskah "Ughn!"
                    scene HighresScreenshot00106
                    window hide # hides the window.
                    $ renpy.pause()
                    scene HighresScreenshot00107
                    window hide # hides the window.
                    $ renpy.pause()
